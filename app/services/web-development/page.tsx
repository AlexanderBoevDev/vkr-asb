  ...
  const suggestData = [
    {
      ...
      description: "Площадка для индивидуальной работы с вашими клиентами - персональные цены, предложение, скидки и акции, дисплей системы лояльности, оповещение и напоминание."
    },
    {
      icon: Icon10,
